...
INSERT INTO `cliente` VALUES ('Cliente no registrado',' ',' ','0000000000000','000000000000000000','1111',20,'2019-05-07',0),('Juan','Dominguez','Dominguez','JCDD961206','JCDD961206VZM03','1232454678',17,'2019-06-11',0);
...
INSERT INTO `contrato` VALUES (0,'0000000000000',0,8,2,'2018-05-20','2018-06-20',NULL),(1,'JCDD961206',0,8,5,'2019-06-11','2019-07-11','Activo'),(2,'JCDD961206',0,8,5,'2019-06-11','2019-07-11','Cancelado');
...
CREATE TABLE `pago` (
  ...
  PRIMARY KEY (`idPago`),
  KEY `fk_Pago_contrato1_idx` (`contrato_idContrato`),
  CONSTRAINT `fk_Pago_contrato1` FOREIGN KEY (`contrato_idContrato`) REFERENCES `contrato` (`idContrato`)
...
INSERT INTO `pago` VALUES (13,'2019-06-11','2019-06-26',1,159750,19500,319500),(14,'2019-06-26','2019-07-11',1,169500,39000,339000),(15,'2019-06-11','2019-06-26',2,230050,28086,460100),(16,'2019-06-26','2019-07-11',2,244100,56173,488200);
...
INSERT INTO `prenda` VALUES ('Prenda de prueba',2500,1800,0,0,3),('Prueba',1970,1200,1,1,1),('Prueba 2',2000,1800,2,1,1),('asdffegrhtjyk',21456,4321,3,2,1);
...
CREATE TABLE `ticket` (
  ...
  KEY `fk_VentaApartado_has_Articulo_Articulo1_idx` (`Articulo_idArticulo`),
  KEY `fk_VentaApartado_has_Articulo_VentaApartado1_idx` (`VentaApartado`),
  CONSTRAINT `fk_VentaApartado_has_Articulo_Articulo1` FOREIGN KEY (`Articulo_idArticulo`) REFERENCES `articulo` (`idArticulo`),
  CONSTRAINT `fk_VentaApartado_has_Articulo_VentaApartado1` FOREIGN KEY (`VentaApartado`) REFERENCES `ventaapartado` (`idVentaApartado`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (0,'Usuario default','root',7,'2019-05-09',0),(3,'Juan Carlos Dominguez','123',7,'2019-06-11',0);
...
-- Dump completed on 2019-06-11 22:57:59
