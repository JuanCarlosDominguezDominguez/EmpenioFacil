...
public class CategoriaDAOTest {
    ...
    /*@Test Esta si pasa sin marcar excepciones
    public void registrarCategoriaExito(){
        boolean valorEsperado = true;
        boolean valorObtenido = CategoriaDAO.registrarCategoria(2, "Test");
        assertEquals("Categoria registrada", valorEsperado, valorObtenido);
    }*/
    /*@Test
    public void registrarCategoriaFracaso() {
        boolean valorEsperado = false;
        boolean valorObtenido = CategoriaDAO.registrarCategoria(1, "Test eliminar");
 ...
 /*@Test Esta si pasa sin marcar excepciones
    public void actualizarCategoriaExito(){
        boolean valorEsperado = true;
        boolean valorObtenido = CategoriaDAO.actualizarCategoria(35, "Test actualizar");
        assertEquals("Categoria no eliminada", valorEsperado, valorObtenido);
    }*/
 ...
 /*@Test Esta si pasa sin marcar excepciones
    public void actualizarCategoriaFracaso() {
        boolean valorEsperado = false;
        boolean valorObtenido = CategoriaDAO.actualizarCategoria(0, "Test actualizar");
        assertEquals("Categoria no eliminada", valorEsperado, valorObtenido);
    }*/
}
